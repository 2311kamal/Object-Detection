...
url = "http://172.20.10.12:8080/shot.jpg"
...
def camera_stream():
    ...
    while True:
        ...
        if os.path.exists(predicted_image_path):
            ...
            img2=cv2.putText(img2, f"  Total Count:{output}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            predicted_image_path_2 = os.path.join(f'Temp2/photos{i}', "image0.jpg")
            ...
            img=cv2.putText(img, f"  Total Count:{output}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
